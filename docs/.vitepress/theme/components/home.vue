...
<template>
  <div class="ui-home">
    <div class="ui-project">
      <div class="item" v-for="v in contentData" :key="v.name">
        <div class="link">
          <div :class="['title', v.className]">{{ v.name }}</div>
...
<script setup>
import { contentData } from '../model/contentData.js'

</script>
<style lang="scss" scoped>
.color-green {background: var(--vp-c-brand-1);}
...
.color-green-gradient4{
	background: -webkit-linear-gradient(45deg, #42d392 25%, #647eff);
	background: linear-gradient(45deg, #42d392 25%, #647eff);
}
